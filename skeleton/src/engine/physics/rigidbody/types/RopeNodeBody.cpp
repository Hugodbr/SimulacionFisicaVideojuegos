...
RopeNodeBody::RopeNodeBody(const physx::PxVec3 &center, const std::string &filePath, float scale)
{
    createRenderableEntity(filePath, scale);
    initiallize(center);
}

RopeNodeBody::RopeNodeBody(const physx::PxVec3 &center, const std::string &filePath, double mass, float scale)
{
    createRenderableEntity(filePath, scale);
    initiallize(center);
...
void RopeNodeBody::initiallize(const physx::PxVec3 &center)
{
